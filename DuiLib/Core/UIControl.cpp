...
void CControlUI::SetBkImage(LPCTSTR pStrImage, bool force)
{
    if(!force && m_bkImage.GetAttributeString() == pStrImage ) return;

    m_bkImage.SetAttributeString(pStrImage, force);
    Invalidate();
}
